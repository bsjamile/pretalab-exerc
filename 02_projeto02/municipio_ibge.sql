SELECT F.id_municipio, M.nome_municipio
...
ON F.id_municipio = M.codigo_ibge; --4639773

SELECT COUNT(id_municipio)
FROM `basedosdados.br_inpe_queimadas.microdados`; --4639773


CREATE SCHEMA `utility-destiny-434909-n4.base_municipio_ibge` OPTIONS(location="US");

SELECT * FROM `utility-destiny-434909-n4.base_municipio_ibge.municipios_ibge` 
ORDER BY
    nome_municipio;

CREATE TABLE `utility-destiny-434909-n4.base_municipio_ibge.municipios_ibge` (
    codigo_ibge STRING,
    nome_municipio STRING
);

INSERT INTO `utility-destiny-434909-n4.base_municipio_ibge.municipios_ibge` VALUES 
